...
names_files = os.listdir('/home/oem/Desktop/dataset_coco/val/labels_old')

for name_file in names_files:

    df_table_old = pd.read_table(f'/home/oem/Desktop/dataset_coco/val/labels_old/{name_file}', delim_whitespace=True, names=('CLASS', 'POINT1', 'POINT2', 'POINT3', 'POINT4'))
    ...
    if not df_table_old[df_table_old['CLASS']==24].empty or not df_table_old[df_table_old['CLASS']==26].empty or not df_table_old[df_table_old['CLASS']==28].empty:
        ...
        path = f'/home/oem/Desktop/dataset_coco/val/labels_new/{name_file}'
